...
namespace DataIntelligence.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260806115019_AiAssistantAuditLog")]
    partial class AiAssistantAuditLog
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("AssistantQuery", "ai", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_AssistantQuery_Validation", "[ValidationOutcome] IN ('Pending','Approved','RejectedNotSelect','RejectedForbiddenObject','RejectedSyntax','RejectedComplexity','RejectedNoSql')");
                        });
                });
