...
namespace DataIntelligence.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260806132142_AssistantExplanationAndRefusalKind")]
    partial class AssistantExplanationAndRefusalKind
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("AssistantQuery", "ai", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_AssistantQuery_Validation", "[ValidationOutcome] IN ('Pending','Approved','RejectedNotSelect','RejectedForbiddenObject','RejectedSyntax','RejectedComplexity','RejectedNoSql','NotADataQuestion')");
                        });
                });
            ...
            modelBuilder.Entity("DataIntelligence.Core.Entities.AssistantFeedback", b =>
                {
                    b.HasOne("DataIntelligence.Core.Entities.AssistantQuery", "Query")
                        .WithOne("Feedback")
                        .HasForeignKey("DataIntelligence.Core.Entities.AssistantFeedback", "AssistantQueryId")
